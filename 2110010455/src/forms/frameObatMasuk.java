 ...
 * @author User
 */
public class frameObatMasuk extends javax.swing.JFrame {

    private datasetObatMasuk obatMasuk;
    /**
     * Creates new form frameObatMasuk
     */
    public frameObatMasuk() {
        initComponents();
        this.setLocationRelativeTo(null);
        obatMasuk = new datasetObatMasuk();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Form Obat Masuk");
                        ...
                        .addGroup(layout.createSequentialGroup()
                            ...
                            .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                ...
                                .addGroup(layout.createSequentialGroup()
                                    ...
                                    .addGap(18, 18, 18)
                                    .addComponent(txtTanggalMasuk, javax.swing.GroupLayout.PREFERRED_SIZE, 169, javax.swing.GroupLayout.PREFERRED_SIZE))))))
        ...
        layout.linkSize(javax.swing.SwingConstants.HORIZONTAL, new java.awt.Component[] {txtIdObat, txtJenisObat, txtJumlahObat, txtKodeObat, txtNamaObat, txtTanggalMasuk});
    ...
    private void btnTambahDataActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnTambahDataActionPerformed
        ...
        obatMasuk.insertIdObat(txtIdObat.getText());
        obatMasuk.insertKodeObat(txtKodeObat.getText());
        obatMasuk.insertNamaObatMasuk(txtNamaObat.getText());
        obatMasuk.insertJenisObatMasuk(txtJenisObat.getText());
        obatMasuk.insertJumlahObatMasuk(txtJumlahObat.getText());
        obatMasuk.insertTanggalMasuk(txtTanggalMasuk.getText());
    ...
    private void btnBacaDataActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBacaDataActionPerformed
        ...
        String isiObat = "Id Obat : "+obatMasuk.getRecordIdObat().get(i)+
                          "\nKode Obat : "+obatMasuk.getRecordKodeObat().get(i)+
                          "\nNama Obat : "+obatMasuk.getRecordNamaObatMasuk().get(i)+
                          "\nJenis Obat : "+obatMasuk.getRecordJenisObatMasuk().get(i)+
                          "\nJumlah Obat : "+obatMasuk.getRecordJumlahObatMasuk().get(i)+
                          "\nTanggal Masuk : "+obatMasuk.getRecordTanggalMasuk().get(i);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frameObatMasuk.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
